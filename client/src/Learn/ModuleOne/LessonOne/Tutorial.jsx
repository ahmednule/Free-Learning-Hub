...
<html lang="en">
  ...
  return (
    <div>
      <h1 className='text-xl font-semibold md:text-2xl underline underline-offset-[16px] pb-10'>Basic HTML Elements</h1>
