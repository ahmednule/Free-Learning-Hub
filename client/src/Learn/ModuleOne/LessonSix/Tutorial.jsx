...
const Tutorial = () => {
  ...
  const codeString5 = `<picture>
  <source media="(min-width: 650px)" srcset="image-large.jpg">
  <source media="(min-width: 465px)" srcset="image-medium.jpg">
  <img src="image.jpg" alt="Description of image">
</picture>`;
  const codeString6 = `<img src="image.jpg" alt="Description of image" loading="lazy">`;
  const codeString7 = `<figure>
  <img src="image.jpg" alt="Description of image">
