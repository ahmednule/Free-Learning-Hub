...
<html>
  ...
  return (
    <div>
      <h1 className='text-xl font-semibold md:text-2xl underline underline-offset-[16px] pb-10'>Text Formating</h1>
      ...
      <article className='mt-6 font-md flex flex-col gap-8 mb-20'>
        <p>Text formatting in HTML is essential for presenting content in a visually appealing and structured manner. By employing various formatting elements and attributes, developers can enhance the readability and aesthetics of their web pages. Let&apos;s delve deeper into each aspect of text formatting:</p>
          ...
          <h4 className='text-xl font-semibold'>Paragraphs:</h4>
        ...
        <h4 className='text-xl font-semibold'>Text Formatting Elements:</h4>
        <p>HTML provides elements for applying basic text formatting to enhance emphasis and clarity:</p>
        <ol className='flex flex-col gap-4'>
          <li>1. <span className='font-semibold text-[17px]'><span className='code'>&lt;b&gt;</span> and <span className='code'>&lt;strong&gt;</span></span>: These elements render text in semibold, signifying importance.</li>
          <Snippet codeString={codeString3} lang='html' title='HTML' />
          <li>2. <span className='font-semibold text-[17px]'><span className='code'>&lt;i&gt;</span> and <span className='code'>&lt;em&gt;</span></span>: These elements italicize text, indicating emphasis or a change in tone.</li>
          <Snippet codeString={codeString4} lang='html' title='HTML' />
          <li>3. <span className='font-semibold text-[17px]'><span className='code'>&lt;u&gt;</span></span>: The <span className='code'>&lt;u&gt;</span> element underlines text, drawing attention to specific content.</li>
          <Snippet codeString={codeString5} lang='html' title='HTML' />
          <li>4. <span className='font-semibold text-[17px]'><span className='code'>&lt;s&gt;</span></span>: The <span className='code'>&lt;s&gt;</span> element strikes through text, indicating deletion or outdated information.</li>
          <Snippet codeString={codeString6} lang='html' title='HTML' />
          <li>5. <span className='font-semibold text-[17px]'><span className='code'>&lt;sub&gt;</span> and <span className='code'>&lt;sup&gt;</span></span>: These elements create subscript and superscript text, respectively, useful for scientific or mathematical annotations.</li>
          <Snippet codeString={codeString7} lang='html' title='HTML' />
        </ol>
        <h4 className='text-xl font-semibold'>Line Breaks:</h4>
        ...
        <h4 className='text-xl font-semibold'>Horizontal Rule:</h4>
