...
const Tools = () => {
  ...
  return (
    <div>
      <h1 className="font-xl md:text-2xl lg:text-4xl text-center">Find all tools you need to go about your online tasks.</h1>
			<div className="grid lg:grid-cols-2 gap-3 mt-14 mb-36">
				{toolsCollection.map((tool) => (
					<div key={tool.id} className="flex group w-full h-32 bg-blue-500/5 border border-blue-500/15 rounded-2xl hover:bg-blue-500/10 hover:border-blue-500/20 duration-200">
						...
						<div className="flex-[0.85]">
							...
							<Link to={tool.link} className="text-blue-500 hover:text-bl duration-200 flex gap-3 items-center">
