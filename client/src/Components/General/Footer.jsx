			...
			<div className='border-t border-gray-700 py-8 flex flex-col-reverse gap-5 md:justify-between md:flex-row'>
				...
				<div className='flex gap-1 text-xl items-center'>
					<a
						...
						target='_blank'
						rel='noreferer'
						className='p-2 hover:bg-gray-700 duration-200 cursor-pointer rounded-full'>
						<FaGithub />
					</a>
					<a
						href='https://discord.gg/mgjhY74Jrn'
						target='_blank'
						rel='noreferer'
						className='p-2 hover:bg-gray-700 duration-200 cursor-pointer rounded-full'>
						<FaDiscord />
					...
					<a
						href='mailto:999patrickobama@gmail.com'
						target='_blank'
						rel='noreferer'
						className='p-2 hover:bg-gray-700 duration-200 cursor-pointer rounded-full'>
						<FaMailchimp />
