		...
		<div className='flex flex-col gap-3'>
			{allModules.map((lang) => {
				...
				return (
					<div
						key={lang.id}
						className='w-full bg-blue-500/5 border border-blue-500/15 hover:bg-blue-500/10 hover:border-blue-500/20 duration-200 cursor-pointer rounded-2xl flex p-4'>
			...
			<div className='w-full'>
				<div className='mt-6 bg-blue-500 hover:bg-blue-600 duration-200 mx-auto lg:mx-0 py-2 px-6 rounded text-gray-950 font-semibold w-fit group cursor-pointer'>
					<span className='group-hover:text-gray-800 duration-200'>
						<Link to={'/learn'}>EXPLORE ALL MODULES</Link>
					</span>
				</div>
