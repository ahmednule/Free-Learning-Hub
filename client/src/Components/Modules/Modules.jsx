		...
		<div className='border border-primary rounded-md'>
			<div className='border-b border-primary sticky top-14 bg-primary-900 flex items-center font-semibold justify-start gap-5 px-2 rounded-t-md pt-5'>
				<div
					...
					className={
						activeTab === 1
							? 'border-b-2 border-reds pb-2 px-2 cursor-pointer'
							: 'border-b-2 border-transparent pb-2 px-2 cursor-pointer'
					}>
					<span className='hover:bg-primary-600 pb-1 pt-3 px-1 duration-200 rounded'>
						ALL MODULES
					</span>
				</div>
				<div
