    ...
    <div>
      <div className='mt-36 flex justify-between'>
        <div className='flex justify-start gap-2'>
          ...
          <button onClick={() => navigate(reset)} className='py-2 px-3 dark:text-gray-950 bg-yellow-500 dark:bg-blue-600 rounded-lg hover:bg-yellow-600 dark:hover:bg-blue-800'>
            <FaArrowRotateRight className='hover:animate-spin' size={19} />
          </button>
        </div>
        <button onClick={() => navigate(l2)} className='flex group justify-center dark:text-gray-950 duration-300 transition-all bg-yellow-500 dark:bg-blue-600 py-2 rounded-lg dark:hover:bg-blue-800 hover:bg-yellow-600 px-5 gap-2'>
          <span> {t2} </span>
          <span>
